...
Capstone Project ワークショップへようこそ、このエクスペリエンスを最大限に活用することから始めましょう。
...
1. 新しいブラウザータブを開き、次のURLに移動します： **[https://github.com/login](https://github.com/login)**

   ![Enter Your Password](./media/Git1.png)

1. 「Sign in to GitHub」ページで、**ユーザー名**（1）**とパスワード**（2）の欄に個人の GitHub **資格情報を入力し、［Sign in］（3）**をクリックします。

   ![Enter Your Password](./media/Git2.png)

1. 確認コードの入力を求められた場合は、登録済みのメールまたは認証アプリに届いた GitHub の認証コードを入力します。
